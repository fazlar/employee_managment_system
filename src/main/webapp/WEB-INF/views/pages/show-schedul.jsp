                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="breadcome-heading">
                                            <form role="search" class="sr-input-func" action="/serche-schedulinfo" method="post">
                                            <table>
                                            <tr>
                                                <td>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                        <div class="sparkline9-list mt-b-30 res-mg-t-30 analysis-progrebar-ctn">
                            ...
                            <div class="sparkline9-graph">
								...
								<tbody>
									<c:forEach var="sche" items="${schedulList}">
										<tr>
											<td>${sche.id }</td>
											...
											<td><a class="btn btn-success"
												href="/schedul/edit/${sche.id}"><i class="fa fa-edit"></i></a>
												<a class="btn btn-success"
												href="/schedul/delete/${sche.id}"><i
