						...
						<div class="product-tab-list tab-pane fade active in"
							...
							<div class="row">
								<c:if test='${Boolean.parseBoolean(success)}'>
									<div class="alert alert-success">${message}<a href="/creatrproject"><i class="fa fa-times" style="margin-left: 1062px;"></i></a></div>
								</c:if>
								<c:if test='${Boolean.parseBoolean(error)}'>
									<div class="alert alert-danger">${message}<a href="/creatrproject"><i class="fa fa-times" style="margin-left: 1062px;"></i></a></div>
								</c:if>
											...
											<form action="/addproject"
												...
												<div class="row">
													<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
														...
														<div class="form-group">
															<input name="frontend" type="text" class="form-control"
													...
													<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
														...
														<div class="form-group">
															<input name="date" id="finish" type="date"
