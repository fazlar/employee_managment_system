                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Project Assingment</a></li>
                                ...
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <div class="row">
                                             <c:if test='${Boolean.parseBoolean(success)}'>
		                                           <div class="alert alert-success">${message}<a href="/assigenPrpject"><i class="fa fa-trash" style="margin-left: 1062px;"></i></a></div>
	                                               </c:if>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="/assigan-project" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload" method="post">
                                                        <div class="row">
															...
															<div class="form-group">
																...
																<div class="form-group">
                                                                    <select name="projectname" class="form-control">
																		<option value="none" selected="" disabled="">Select Project name</option>
